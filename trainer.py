...
class ModelTrainer:
    ...
    def __init__(self, model, train_loader, valid_loader, criterion, optimizer, scheduler, config, epochs, device, save_path, ckpt_path=None, comment=None, fold=2):
        ...
        self.exp_path = Path(os.path.join(save_path, str(fold), datetime.now().strftime('%d%B_%0l%0M'))) #21November_0430
    ...
    def train_single_epoch(self, epoch):
        ...
        return total_loss, (correct_cnt/tot_cnt)*100
    ...
    def test(self):
        ...
        with torch.no_grad():
            for b, batch in tqdm(enumerate(self.test_loader), total=len(self.test_loader)):
                ...
                self.logger.info(("{}/{}: {}/{} ----- {}-{}".format(b, batch_size, correct_cnt, tot_cnt, best_prediction.item(), labels.item())))
